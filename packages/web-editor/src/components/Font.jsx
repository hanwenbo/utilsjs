...
class EditorFont extends Component {
    ...
    render() {
        ...
        return (<Panel {...props} header={props.header || locale.header}>
            {!Arr.inArray('family', exclude) && <Row gutter={8}>
                <Col span={3}>
            ...
            {!Arr.inArray('size', exclude) && <Row gutter={8}>
            ...
            {!Arr.inArray('line-height', exclude) && <Row gutter={8}>
            ...
            {!Arr.inArray('color', exclude) && <Color
                color={value.color}
            ...
            />}
            {!Arr.inArray('decoration', exclude) && <Row>
                <Col span={21} offset={3}>
                    {this.getFontDecoration()}
                </Col>
            </Row>}
            {!Arr.inArray('align', exclude) && <Row>
                <Col span={21} offset={3}>
                    {this.getFontAlign()}
                </Col>
            </Row>}

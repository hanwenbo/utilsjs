...
export default class EditorInterface extends Component {
    ...
    render() {
        const { value, locale, exclude, ...props } = this.props;
        ...
        const floatChild = value.position === 'static' || value.position === 'relative' ? (
                        ...
                        >
                            {Object.keys(locale.floatSelect).map(key => (
                                <RadioButton value={key} key={key}>
                                    <Icon type={key === 'none' ? 'float-close' : `float-${key}`}
                    ...
                    <Col span={21}>
                        ...
                        >
                            {Object.keys(locale.clearSelect).map(key => (
                                <RadioButton value={key} key={key}>
                                    <Icon type={key === 'none' ? 'float-close' : `clear-${key}`}
        ...
        return (
            <Panel {...props} header={props.header || locale.header}>
                {!Arr.inArray('opacity', exclude) &&<RowHelp
                ...
                {!Arr.inArray('overflow', exclude) &&<Row gutter={8}>
                    <Col span={3}>
                ...
                {!Arr.inArray('width', exclude) &&<Row gutter={8}>
                    <Col span={3}>
                ...
                {!Arr.inArray('height', exclude) &&<Row gutter={8}>
                    <Col span={3}>
                ...
                {!Arr.inArray('position', exclude) && <RowHelp
                ...
                {!Arr.inArray('float', exclude) && <TweenOneGroup

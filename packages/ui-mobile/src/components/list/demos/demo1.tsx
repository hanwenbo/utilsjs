...
import { List, Switch ,Toast} from '@hanwenbo/ui-mobile'
import {
  ...
  return (
    <>
      ...
      <List header='可点击的功能列表'>
        <List.Item prefix={<UnorderedListOutline />} onPress={() => {
          Toast.show('~ hi')
        }}>
          账单
        </List.Item>
        <List.Item prefix={<PayCircleOutline />} onPress={() => {}}>
          总资产
        </List.Item>
        <List.Item prefix={<SetOutline />} onPress={() => {}}>
          设置
        </List.Item>
      </List>

      <List header='复杂布局'>
        <List.Item extra={<Switch defaultChecked />}>新消息通知extra</List.Item>
